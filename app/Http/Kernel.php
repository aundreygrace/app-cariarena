...
use Spatie\Permission\Middleware\Role;
use Spatie\Permission\Middleware\Permission;
use Spatie\Permission\Middleware\RoleOrPermission;
...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\InvokeDeferredCallbacks::class,
    ...
    protected $middlewareAliases = [
        ...
        // ==============================
        // MIDDLEWARE CUSTOM UNTUK CARIARENA
        // ==============================
        'check.role' => \App\Http\Middleware\CheckRole::class,
        'check.admin' => \App\Http\Middleware\CheckAdmin::class,
        'check.venue' => \App\Http\Middleware\CheckVenue::class,
        'check.user' => \App\Http\Middleware\CheckUser::class,
        'admin.auth' => \App\Http\Middleware\AdminAuthenticate::class,
        'venue.auth' => \App\Http\Middleware\VenueAuthenticate::class,
