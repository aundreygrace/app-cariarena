...
<?php $__env->startSection('title', 'Venue Saya'); ?>

<?php $__env->startSection('page-title', 'Venue Saya'); ?>
...
<div class="venue-container">
    <div class="venue-grid" id="venueGrid">
        <?php $__empty_1 = true; $__currentLoopData = $venues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="venue-item">
                <div class="venue-card card position-relative" data-venue-id="<?php echo e($venue->id); ?>">
                    <img src="<?php echo e($venue->photo ? (Str::contains($venue->photo, ['http', 'drive.google.com']) ? $venue->photo : asset('storage/' . $venue->photo)) : 'https://source.unsplash.com/400x200/?sports'); ?>" alt="<?php echo e($venue->name); ?>">
                    <span class="badge-status 
                        <?php if($venue->status === 'Aktif'): ?> badge-aktif
                        <?php elseif($venue->status === 'Maintenance'): ?> badge-maintenance
                        <?php else: ?> badge-nonaktif
                        <?php endif; ?>">
                    ...
                    <!-- Tombol Hapus di Sudut Kiri Atas - Dengan Popup Konfirmasi -->
                     <button class="delete-btn top-right-delete" onclick="showDeleteConfirmation(<?php echo e($venue->id); ?>, '<?php echo e($venue->name); ?>', '<?php echo e(route('venue.hapus', $venue->id)); ?>')">
                    ...
                    <div class="card-body">
                        ...
                        <div class="rating">
                            ...
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                ...
                                <?php endif; ?>
                            <?php endfor; ?>
                            <span class="rating-count"><?php echo e(number_format($rating, 1)); ?> (<?php echo e($reviewCount); ?>)</span>
                        </div>
                        <span class="badge"><?php echo e($venue->category); ?></span>
                        
                        <div class="location-price">
                            <p class="text-muted mb-1"><i class="fas fa-map-marker-alt"></i> <?php echo e($venue->address); ?></p>
                            <p class="price"><i class="fas fa-clock"></i> Rp <?php echo e(number_format($venue->price_per_hour, 0, ',', '.')); ?>/jam</p>
                        </div>
                        
                        <div class="facility-grid">
    <?php if(!empty($venue->facilities) && is_array($venue->facilities) && count($venue->facilities) > 0): ?>
        <?php $__currentLoopData = array_slice($venue->facilities, 0, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <span><?php echo e($facility); ?></span>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        
        <?php if(count($venue->facilities) < 4): ?>
            <?php for($i = count($venue->facilities); $i < 4; $i++): ?>
    ...
    <?php endif; ?>
                        ...
                        <div class="action-buttons">
                            ...
                            <!-- Tombol Edit -->
                            <button class="btn" data-bs-toggle="modal" data-bs-target="#editVenueModal" onclick="setEditModalData(<?php echo e($venue->id); ?>)"">
                                <i class="fas fa-edit btn-icon"></i> Edit
                            </button>
                            
                            <!-- Tombol Toggle Status - ROUTE NAME YANG BENAR -->
                            <form action="<?php echo e(route('venue.toggle-status', $venue->id)); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="tambahVenueModal" tabindex="-1" aria-labelledby="tambahVenueModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('venue.tambah')); ?>" method="POST" enctype="multipart/form-data" id="tambahVenueForm">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.venue', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CariArena\resources\views/venue/venue-saya/index.blade.php ENDPATH**/ ?>