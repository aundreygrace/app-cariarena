...
<body>
    <div class="auth-container">
        ...
        <div class="auth-card">
            ...
            <div class="auth-body">
            <input type="hidden" id="hiddenEmail" value="<?php echo e($email ?? ''); ?>">
                <!-- Alert messages -->
                ...
                <div id="resetForm">
                    ...
                    <form method="POST" action="<?php echo e(route('password.email')); ?>" id="passwordResetForm">
                        <?php echo csrf_field(); ?>
...
document.getElementById('resendButton')?.addEventListener('click', function () {
    ...
    const emailValue = "<?php echo e($email ?? ''); ?>"; // ambil dari server
...
</html><?php /**PATH D:\CariArena\resources\views/auth/passwords/email.blade.php ENDPATH**/ ?>