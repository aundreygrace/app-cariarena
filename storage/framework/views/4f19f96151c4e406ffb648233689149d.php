...
<?php $__env->startSection('title', 'Booking Masuk - CariArena Venue'); ?>
<?php $__env->startSection('page-title', 'Booking Masuk'); ?>
...
<div class="search-filter">
    <form id="filterForm" method="GET" action="<?php echo e(route('venue.booking.masuk.index')); ?>">
        <div class="row g-3">
            <div class="col-md-4">
                <input type="text" name="search" class="form-control" id="searchInput" placeholder="🔍 Cari booking, customer, atau venue..." value="<?php echo e(request('search')); ?>">
            </div>
            ...
            <div class="col-md-3">
                <select class="form-control" name="venue_id" id="venueFilter">
                    ...
                    <?php $__currentLoopData = $venues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($venue->id); ?>" <?php echo e(request('venue_id') == $venue->id ? 'selected' : ''); ?>><?php echo e($venue->name); ?></option>
    ...
    <div class="table-container">
        <div class="section-header d-flex justify-content-between align-items-center">
            <h5>📋 Data Booking (<span id="bookingCount"><?php echo e($totalBookings ?? 0); ?></span>)</h5>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody id="bookingTableBody">
                    ...
                    <tr>
                        <td class="fw-bold"><?php echo e($booking->booking_code); ?></td>
                        <td>
                            <div><?php echo e($booking->nama_customer); ?></div>
                            <small class="text-muted"><?php echo e($booking->customer_phone); ?></small>
                        </td>
                        <td><?php echo e($booking->venue->name); ?></td>
                        <td>
                            <div><?php echo e($booking->tanggal_booking->format('d/m/Y')); ?></div>
                            <small class="text-muted"><?php echo e(date('H.i', strtotime($booking->waktu_booking))); ?> - <?php echo e(date('H.i', strtotime($booking->end_time))); ?></small>
                        </td>
                        <td class="fw-bold text-success">Rp <?php echo e(number_format($booking->total_biaya, 0, ',', '.')); ?></td>
                        <td>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <button class="btn btn-info" title="Lihat Detail" onclick="viewBooking(<?php echo e($booking->id); ?>)">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <button class="btn btn-warning" title="Edit" onclick="editBooking(<?php echo e($booking->id); ?>)">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button class="btn btn-danger" title="Hapus" onclick="deleteBooking(<?php echo e($booking->id); ?>)">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="venue" name="venue_id" required>
                                ...
                                <?php $__currentLoopData = $venues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($venue->id); ?>" data-price="<?php echo e($venue->price_per_hour); ?>"><?php echo e($venue->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
<?php $__env->stopPush(); ?>
[file content end]
<?php echo $__env->make('layouts.venue', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CariArena\resources\views/venue/booking-masuk.blade.php ENDPATH**/ ?>