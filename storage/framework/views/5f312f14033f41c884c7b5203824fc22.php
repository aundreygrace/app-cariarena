...
<div class="beranda-page">
    <div class="page-content">
        ...
        <div class="welcome-message fade-in-up">
            <h2>Selamat Datang, <?php echo e(Auth::user()->name ?? 'User'); ?>!</h2>
        ...
        <div class="category-section fade-in-up">
            ...
            <div class="category-buttons">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($category): ?>
                    <button class="category-btn" data-category="<?php echo e($category); ?>"><?php echo e($category); ?></button>
                    <?php endif; ?>
        ...
        <div class="venue-section fade-in-up">
            <div class="section-header">
                ...
                <a href="<?php echo e(route('pesan.index')); ?>" class="lihat-semua-btn">
            ...
            <div class="venue-grid" id="venue-container">
                ...
                <?php $__currentLoopData = $popularVenues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="venue-card venue-item" data-category="<?php echo e($venue->category); ?>">
                    <div class="venue-image <?php if(empty($venue->photo)): ?> no-image <?php endif; ?>" 
                         style="<?php if($venue->photo): ?> background-image: url('<?php echo e(asset('storage/' . $venue->photo)); ?>'); <?php endif; ?>">
                        
                        <?php if(empty($venue->photo)): ?>
                        <div class="venue-icon">
                            <?php if($venue->category == 'Futsal'): ?>
                                ⚽
                            <?php elseif($venue->category == 'Badminton'): ?>
                                🏸
                            <?php elseif($venue->category == 'Basket'): ?>
                                🏀
                            <?php elseif($venue->category == 'Soccer'): ?>
                                ⚽
                            <?php else: ?>
                                🏟
                            <?php endif; ?>
                        ...
                        <div class="venue-badges">
                            <span class="category-badge"><?php echo e(strtoupper($venue->category)); ?></span>
                            <?php if($venue->rating >= 4.5): ?>
                    ...
                    <div class="venue-content">
                        ...
                        <div class="venue-details">
                            <div class="venue-rating">
                                <div class="rating-stars">
                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        <?php if($i <= floor($venue->rating)): ?>
                                            <i class="fas fa-star"></i>
                                        <?php elseif($i == ceil($venue->rating) && fmod($venue->rating, 1) >= 0.5): ?>
                                ...
                                <div class="rating-info">
                                    <span class="rating-text"><?php echo e(number_format($venue->rating, 1)); ?>/5.0 (<?php echo e($venue->reviews_count); ?>)</span>
                                </div>
                            </div>
                            <div class="venue-price">
                                <?php if($venue->price_per_hour): ?>
                                <span class="price-text">Rp <?php echo e(number_format($venue->price_per_hour, 0, ',', '.')); ?></span>
                        ...
                        <div class="venue-action">
                            <a href="<?php echo e(route('pesan.pesan-sekarang', ['id' => $venue->id])); ?>" class="booking-btn">
        ...
        <div class="notification-section fade-in-up">
            <div class="section-header">
                ...
                <a href="<?php echo e(route('notifikasi.index')); ?>" class="lihat-semua-btn">
                    Lihat Semua <i class="fas fa-arrow-right"></i>
                </a>
            </div>
            <div class="notification-list">
                ...
                <?php if($recentNotifications && $recentNotifications->count() > 0): ?>
                    ...
                    <div class="notification-item">
                        <div class="notification-header">
                            <span class="notification-title"><?php echo e($notification->title); ?></span>
                            <span class="notification-time"><?php echo e(\Carbon\Carbon::parse($notification->created_at)->diffForHumans()); ?></span>
                        </div>
            ...
            <div class="facilities-grid">
                ...
                <div class="facility-item">
                    <div class="facility-icon">
                        <?php if($facility == 'Parkir'): ?>
                            <i class="fas fa-parking"></i>
                        <?php elseif($facility == 'Kamar Mandi'): ?>
                            <i class="fas fa-toilet"></i>
                        <?php elseif($facility == 'Ruang Ganti'): ?>
                            <i class="fas fa-tshirt"></i>
                        <?php elseif($facility == 'Musholla'): ?>
                            <i class="fas fa-mosque"></i>
                        <?php elseif($facility == 'Ruang Tunggu'): ?>
                            <i class="fas fa-couch"></i>
                        <?php elseif($facility == 'Kantin'): ?>
                            <i class="fas fa-utensils"></i>
                        <?php endif; ?>
                    </div>
                    <span class="facility-name"><?php echo e($facility); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CariArena\resources\views/user/beranda.blade.php ENDPATH**/ ?>