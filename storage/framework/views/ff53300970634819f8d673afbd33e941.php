...
<?php $__env->startSection('title', 'Atur Jadwal'); ?>

<?php $__env->startSection('page-title', 'Atur Jadwal'); ?>

<?php $__env->startSection('content'); ?>
<div class="content-main ">
    <!-- Tombol Kembali -->
    <a href="<?php echo e(route('venue.jadwal.index')); ?>" class="back-button">
    ...
    <div class="content">
        ...
        <aside class="card form-container">
            ...
            <form action="<?php echo e(route('venue.jadwal.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-row">
                    ...
                    <?php if(isset($venue) && $venue): ?>
                        <input type="text" class="form-control" value="<?php echo e($venue->name); ?>" readonly>
                ...
                <div class="form-row">
                    <label>Tanggal:</label>
                    <input type="date" name="tanggal" class="form-control" id="tanggal-input" min="<?php echo e(date('Y-m-d')); ?>" required>
                    ...
                    <div class="time-select-container">
                        <select name="waktu_mulai" class="form-control time-select" id="waktu-mulai-select" required>
                            ...
                            <?php $__currentLoopData = $times; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($time['value']); ?>"><?php echo e($time['label']); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                ...
                <div style="margin-top: 20px;">
                    <button type="submit" class="btn" <?php echo e(!isset($venue) || !$venue ? 'disabled' : ''); ?>>
            ...
            <?php if(isset($venue) && $venue): ?>
                <div class="venue-info mt-4 p-3" style="background: #f8f9fa; border-radius: 8px; border-left: 4px solid #1E40AF;">
                    ...
                    <div style="font-size: 0.9rem;">
                        <p style="margin-bottom: 5px;"><strong>Nama:</strong> <?php echo e($venue->name); ?></p>
                        <p style="margin-bottom: 5px;"><strong>Kategori:</strong> <?php echo e($venue->category ?? 'Tidak ada'); ?></p>
                        <p style="margin-bottom: 5px;"><strong>Harga per Jam:</strong> Rp <?php echo e(number_format($venue->price_per_hour ?? 0, 0, ',', '.')); ?></p>
                        <p style="margin-bottom: 0;"><strong>Alamat:</strong> <?php echo e($venue->address ?? 'Tidak ada'); ?></p>
                    </div>
                </div>
            <?php endif; ?>
        </aside>
...
<?php echo $__env->make('layouts.venue', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CariArena\resources\views/venue/jadwal/atur-jadwal.blade.php ENDPATH**/ ?>