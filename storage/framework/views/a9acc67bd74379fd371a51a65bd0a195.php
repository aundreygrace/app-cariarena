...
<?php $__env->startSection('title', 'Jadwal Booking'); ?>

<?php $__env->startSection('page-title', 'Jadwal Booking'); ?>
    ...
    <div class="right-panel">
        <div class="right-panel-header">
            <div class="day-title">
                ...
                <button class="btn-atur-jadwal" id="btnAturJadwal" onclick="window.location.href='<?php echo e(route('venue.jadwal.atur')); ?>'">
...
<div class="summary-cards">
    ...
    <div class="summary-card">
        <div class="stat-number">Rp <?php echo e(number_format($todayRevenue ?? 0, 0, ',', '.')); ?></div>
        <div class="stat-label">Pendapatan Hari Ini</div>
    </div>
    <!-- PERBAIKAN: Tambahkan card untuk total pendapatan -->
    <div class="summary-card">
        <div class="stat-number">Rp <?php echo e(number_format($totalRevenue ?? 0, 0, ',', '.')); ?></div>
...
<script>
    ...
    const bookingsData = <?php echo json_encode($bookingsData, 15, 512) ?>;
    
    const statsData = {
        totalBookings: <?php echo e($totalBookings ?? 0); ?>,
        confirmedBookings: <?php echo e($confirmedBookings ?? 0); ?>,
        pendingBookings: <?php echo e($pendingBookings ?? 0); ?>,
        todayRevenue: <?php echo e($todayRevenue ?? 0); ?>,
        totalRevenue: <?php echo e($totalRevenue ?? 0); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.venue', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CariArena\resources\views/venue/jadwal/index.blade.php ENDPATH**/ ?>