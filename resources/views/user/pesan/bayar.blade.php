...
<body>
        ...
        <div class="venue-detail-card">
            ...
            <div class="venue-image-section">
                ...
                <div class="venue-overlay">
                    ...
                    <span class="badge badge-rating">
                        ...
                        {{ number_format($venue->averageRating ?? 4.5, 1) }}/5
                    </span>
                </div>
            </div>
            ...
            <div class="venue-content">
                ...
                <div class="venue-header">
                    <h2 class="venue-name">{{ $venue->name ?? 'Arena Futsal Corner' }}</h2>
                    <div class="venue-price">
                        <div class="price-label">Harga per jam</div>
                        <div class="price-tag">Rp {{ number_format($venue->price_per_hour ?? 120000, 0, ',', '.') }}</div>
                    </div>
                </div>
                ...
                <div class="venue-info">
                    <div class="info-item">
                        ...
                        <span>{{ $venue->address ?? 'Bintaro, Jakarta Selatan' }}</span>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        ...
                        <span>Kategori: {{ $venue->category ?? 'Futsal' }}</span>
                    </div>
                    <div class="info-item">
                        <i class="fas fa-star"></i>
                        <span>Rating: {{ number_format($venue->averageRating ?? 4.5, 1) }}/5.0</span>
                    </div>
                </div>
                ...
                <div class="booking-details-section">
                    ...
                    <div class="booking-details-grid">
                        <div class="booking-detail-item">
                            ...
                            <div class="booking-detail-value" id="booking-date">{{ $date ?? 'Minggu, 2 Nov 2023' }}</div>
                        </div>
                        <div class="booking-detail-item">
                            <div class="booking-detail-label">Waktu</div>
                            <div class="booking-detail-value" id="booking-time">{{ $time ?? '07.00' }}</div>
                        </div>
                        <div class="booking-detail-item">
                            <div class="booking-detail-label">Durasi</div>
                            <div class="booking-detail-value" id="booking-duration">{{ $duration ?? '2 Jam' }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="payment-summary-section">
                    ...
                    <div class="summary-container">
                        <div class="summary-row">
                            <div class="summary-label">Sewa lapangan ({{ $duration ? str_replace(' Jam', '', $duration) : '2' }} jam)</div>
                            <div class="summary-value" id="venue-cost">Rp {{ number_format($total ?? 240000, 0, ',', '.') }}</div>
                        </div>
                        <div class="summary-row">
                            <div class="summary-label">Biaya admin</div>
                            <div class="summary-value" id="admin-fee">Rp {{ number_format($adminFee ?? 5000, 0, ',', '.') }}</div>
                        </div>
                        <div class="summary-row total-row">
                            <div class="total-label">Total Pembayaran</div>
                            <div class="total-value" id="total-payment">Rp {{ number_format($totalPayment ?? 245000, 0, ',', '.') }}</div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function processPayment() {
            ...
            const venueName = "{{ $venue->name ?? 'Arena Futsal Corner' }}";
            const address = "{{ $venue->address ?? 'Bintaro, Jakarta Selatan' }}";
            ...
            const redirectUrl = "{{ route('pesan.riwayat-booking') }}?" + new URLSearchParams({
                status: 'success',
