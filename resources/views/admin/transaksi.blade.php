...
@section('title', 'Manajemen Transaksi - CariArena')
...
@section('content')
    ...
    <div class="cards">
        <div class="card">
            ...
            <h3>{{ number_format($statistik['total_hari_ini'] ?? 0) }}</h3>
        ...
        <div class="card">
            ...
            <h3>{{ number_format($statistik['pending_count'] ?? 0) }}</h3>
            <small>Transaksi pending</small>
        </div>

        <div class="card">
            <small>Transaksi Berhasil</small>
            <h3>{{ number_format($statistik['success_count'] ?? 0) }}</h3>
    ...
    <div class="filter-card">
        ...
        <div class="section-body">
            <form method="GET" action="{{ route('admin.transaksi.index') }}" id="filterForm" class="filter-form">
                ...
                <div class="row g-3 align-items-end">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="searchInput" name="search" 
                               placeholder="Kode transaksi atau nama..." value="{{ request('search') }}">
                    </div>
                    <div class="col-md-2">
    ...
    <div class="dashboard-section">
        ...
        <div class="section-body">
                ...
                <table class="table table-hover" id="transactionsTable">
                    ...
                    <tbody id="transactionsTableBody">
                        ...
                        <tr>
                            ...
                            <td class="fw-bold text-success">Rp {{ number_format($transaksi->amount, 0, ',', '.') }}</td>
                            <td>
                            ...
                            <td>{{ \Carbon\Carbon::parse($transaksi->transaction_date)->format('d/m/Y H:i') }}</td>
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    @if($transaksi->status == 'pending')
                                    <!-- Tombol Konfirmasi -->
                                    <form action="{{ route('admin.transaksi.confirm', $transaksi) }}" method="POST" class="action-form">
                                        @csrf
                                    ...
                                    <!-- Tombol Tolak -->
                                    <form action="{{ route('admin.transaksi.reject', $transaksi) }}" method="POST" class="action-form">
                                        @csrf
            ...
            <div class="pagination-container">
                ...
                <div class="pagination-info">
                    @if($perPage === 'all' || $perPage >= $totalItems)
                        Menampilkan semua {{ $totalItems }} transaksi
                    @else
                        Menampilkan {{ $displayText }} dari {{ $totalItems }} transaksi
                    @endif
                </div>
                <div class="items-per-page">
                    <span class="items-per-page-label">Tampilkan:</span>
