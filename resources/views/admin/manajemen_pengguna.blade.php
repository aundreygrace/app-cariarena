...
@section('content')
    ...
    <div class="cards">
        ...
        <div class="card">
            ...
            <h3>{{ number_format($pemilikVenue ?? 0) }}</h3>
        ...
        <div class="card">
            <small>Admin</small>
            <h3>{{ number_format($totalAdmin ?? 0) }}</h3>
    ...
    <div class="filter-card">
        ...
        <div class="section-body">
            <form method="GET" action="{{ route('admin.pengguna.index') }}" id="filterForm" class="filter-form">
                ...
                <div class="row g-3 align-items-end">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="searchInput" name="search" 
                               placeholder="Cari nama, email, atau venue..." value="{{ request('search') }}">
                    </div>
                    <div class="col-md-2">
                        ...
                        <select class="form-select" id="typeFilter" name="type">
                            ...
                            <option value="venue" {{ request('type') == 'venue' ? 'selected' : '' }}>Pemilik Venue</option>
                            <option value="user" {{ request('type') == 'user' ? 'selected' : '' }}>Pengguna Biasa</option>
                        </select>
                    </div>
                    <div class="col-md-2">
        ...
        <div class="dashboard-section">
                    ...
                    <tbody id="usersTableBody">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    @if($user->profile_photo && $user->profile_photo != '[null]')
                                        <img src="{{ Storage::url($user->profile_photo) }}" alt="{{ $user->name }}" class="rounded-circle me-2" width="32" height="32">
                                    @else
                            ...
                            <td class="text-truncate">
                                @if($user->venue_name && $user->venue_name != '[null]')
                                    {{ $user->venue_name }}
                                @else
                                    -
                                @endif
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <button class="btn btn-info" title="Lihat Detail" data-bs-toggle="modal" data-bs-target="#detailPenggunaModal" data-user-id="{{ $user->id }}">
            ...
            <div class="pagination-container">
                <div class="pagination-info">
                    ...
                    @endphp
                    Menampilkan {{ $start }} - {{ $end }} dari {{ $totalItems }} pengguna
                </div>
            ...
            <div class="pagination-container">
                ...
                <div class="pagination-info">
                    @if($perPage === 'all' || $perPage >= $totalItems)
                        Menampilkan semua {{ $totalItems }} pengguna
                    @else
                        Menampilkan {{ $displayText }} dari {{ $totalItems }} pengguna
                    @endif
                </div>
                <div class="items-per-page">
                    <span class="items-per-page-label">Tampilkan:</span>
