...
@section('title', 'Manajemen Venue - CariArena')
...
@section('content')
    ...
    <div class="cards">
        ...
        <div class="card">
            ...
            <h3>{{ number_format($venueAktif ?? 0) }}</h3>
            <small>Venue yang beroperasi</small>
        </div>

        <div class="card">
            <small>Dalam Perawatan</small>
            <h3>{{ number_format($venuePerawatan ?? 0) }}</h3>
    ...
    <div class="filter-card">
        ...
        <div class="section-body">
            <form method="GET" action="{{ route('admin.venue.index') }}" id="filterForm" class="filter-form">
                ...
                <div class="row g-3 align-items-end">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="searchInput" name="search" 
                               placeholder="Cari nama venue atau lokasi..." value="{{ request('search') }}">
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="form-select" id="categoryFilter" name="category">
                            ...
                            <option value="Soccer" {{ request('category') == 'Soccer' ? 'selected' : '' }}>Soccer</option>
                            <option value="Tennis" {{ request('category') == 'Tennis' ? 'selected' : '' }}>Tennis</option>
                            <option value="Volleyball" {{ request('category') == 'Volleyball' ? 'selected' : '' }}>Volleyball</option>
                        </select>
                    </div>
                    <div class="col-md-4">
        ...
        <div class="section-body">
                ...
                <table class="table table-hover" id="venuesTable">
                    ...
                    <tbody id="venuesTableBody">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge badge-sport">{{ $venue->category }}</span>
                            </td>
                            <td>
                                @php
                            ...
                            <td>
                                ...
                                <small class="text-muted">({{ $venue->reviews_count ?? 0 }})</small>
                            </td>
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <button class="btn btn-eye" title="Lihat Detail" data-bs-toggle="modal" data-bs-target="#detailVenueModal" data-venue-id="{{ $venue->id }}">
            ...
            <div class="pagination-container">
                <div class="pagination-info">
                    ...
                    @endphp
                    Menampilkan {{ $start }} - {{ $end }} dari {{ $totalItems }} venue
                </div>
                ...
                <div class="pagination-controls">
                    <ul class="pagination">
                        ...
                        @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $venues->previousPageUrl() }}" rel="prev">
                                    <i class="fas fa-chevron-left"></i>
                                </a>
                            </li>
                        @endif
                        ...
                        @if($showStartDots)
                            <li class="page-item">
                                <a class="page-link" href="{{ $venues->url(1) }}">1</a>
                            </li>
                            @if($startPage > 2)
                                <li class="page-item disabled">
                        ...
                        @for($page = $startPage; $page <= $endPage; $page++)
                            ...
                            @else
                                <li class="page-item">
                                    <a class="page-link" href="{{ $venues->url($page) }}">{{ $page }}</a>
                                </li>
                            @endif
                        @endfor
                        ...
                        @if($showEndDots)
                            ...
                            @endif
                            <li class="page-item">
                                <a class="page-link" href="{{ $venues->url($lastPage) }}">{{ $lastPage }}</a>
                            </li>
                        @endif
                        ...
                        @if($venues->hasMorePages())
                            <li class="page-item">
                                <a class="page-link" href="{{ $venues->nextPageUrl() }}" rel="next">
            ...
            <div class="pagination-container">
                ...
                <div class="pagination-info">
                    @if($perPage === 'all' || $perPage >= $totalItems)
                        Menampilkan semua {{ $totalItems }} venue
                    @else
                        Menampilkan {{ $displayText }} dari {{ $totalItems }} venue
                    @endif
                </div>
                <div class="items-per-page">
                    <span class="items-per-page-label">Tampilkan:</span>
