...
@section('title', 'Laporan - CariArena Venue')
...
@section('content')
    ...
    <div class="filter-card">
        ...
        <div class="section-body">
            <form method="GET" action="{{ route('venue.reports') }}" id="filterForm" class="filter-form">
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="laporanTable">
                    ...
                    <tr>
                        ...
                        <td>{{ $transaction->nama_venue }}</td>
                        <td>{{ $transaction->pengguna ?? $transaction->customer_name ?? 'N/A' }}</td>
