...
@section('page-title', 'Detail Venue')

@section('content')
<!-- Back Button -->
<a href="{{ route('venue.venue-saya') }}" class="back-button">
...
<div class="venue-header">
    ...
    <div class="venue-rating">
        ...
        @for($i = 1; $i <= 5; $i++)
            ...
            @endif
        @endfor
        <span class="venue-rating-text">{{ number_format($rating, 1) }} ({{ $venue->reviews_count }} ulasan)</span>
    </div>
</div>
...
<div class="venue-content">
    ...
    <div class="info-section">
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <div class="info-value">{{ $venue->name }}</div>
            </div>
            <div class="info-item">
                <div class="info-label">Kategori</div>
                <div class="info-value">{{ $venue->category }}</div>
            </div>
            <div class="info-item">
                <div class="info-label">Harga</div>
                <div class="info-value">Rp {{ number_format($venue->price_per_hour, 0, ',', '.') }}/jam</div>
            </div>
            <div class="info-item">
    ...
    <div class="info-value">
        <span class="badge 
            ...
            @elseif($venue->status === 'Tidak Aktif') badge-nonaktif
            @else badge-secondary
            @endif">
            {{ $venue->status ?? 'Tidak Diketahui' }}
        </span>
    </div>
</div>
            <div class="info-item">
            ...
            <div class="info-item">
                ...
                <div class="info-value">{{ $venue->reviews_count }} ulasan</div>
            </div>
        </div>
