...
<body>
    <div class="app-container">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="logo">
                <i class="fas fa-volleyball-ball"></i>
                <h2>CariArena @yield('role-text', '')</h2>
            </div>
            <hr>
                        ...
                        @auth
                            @if(Auth::user()->profile_picture)
                                <img src="{{ asset('storage/' . Auth::user()->profile_picture) }}" 
                                     alt="{{ Auth::user()->name }}" 
                                     onerror="this.src='https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=63B3ED&color=fff'">
                            @else
                                <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=63B3ED&color=fff" 
                                     alt="{{ Auth::user()->name }}">
                            @endif
                    ...
                    <div class="profile-dropdown" id="profileDropdown">
                        ...
                        @auth
                            ...
                            @if(Auth::user()->role === 'admin')
                                <a href="{{ route('admin.dashboard') }}" class="profile-dropdown-item">
                                    <i class="fas fa-tachometer-alt"></i>
                                    Admin Dashboard
                                </a>
                            @elseif(Auth::user()->role === 'venue')
                                <a href="{{ route('venue.dashboard') }}" class="profile-dropdown-item">
                        ...
                        @else
                            ...
                            <a href="{{ route('register') }}" class="profile-dropdown-item">
    ...
    <script>
        ...
        function goToProfile() {
            @auth
                @if(View::hasSection('user-profile-link'))
                    window.location.href = "@yield('user-profile-link')";
                @else
